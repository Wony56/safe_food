				...
				<table>
					<tr>
						...
						<td><textarea class="notice-title" name="title" cols="100"
								rows="1" placeholder="제목을 입력하세요." required="required">${notice.title}</textarea></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><textarea class="notice-content" name="content"
								cols="100" rows="20" placeholder="내용을 입력하세요.">${notice.content}</textarea></td>
					</tr>
				</table>
				<div class="notice-btns">
					<button id="register-btn" type="submit">수정</button>
